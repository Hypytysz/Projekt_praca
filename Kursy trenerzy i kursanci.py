...
while (True):
    ...
    if menu == 1:
        ...
        if znaleziono == "NIE":
            print(f"Nie ma takiego kursu.")
        # pytania: nazwa kursu, imie, nazwisko, telefon
    elif menu == 4:
        ...
        # pytania: nazwa kursu (usunac kurs mozna tylko wtedy kiedy nie ma przyspianych do niego zadnych kursantow)
    elif menu == 7:
        break
